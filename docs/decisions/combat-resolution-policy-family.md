...
Content is currently schema v7 and active packs are version `0.7.0`. Weapon
...
Save contract v13 retains charge policy identity and rejects restoration under
