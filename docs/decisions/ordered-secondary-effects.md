...
**Implementation state:** O2-R8 through O2-R12 complete; O2-R13 through O2-R16 pending
...
- Content receives additive local effect IDs, dependencies, and secondary
  damage mode fields under schema v5.
...
- Save contract v11 is unchanged because definitions and transient execution
