...
- **Battle:** defense resolution, combat rules, ailments, passives, lifecycle, Action Token and generic turn-economy contracts, manual action execution, automated action selection, encounter orchestration, negotiation, recruitment decisions, rewards, and typed knowledge stores.
