...
public sealed class ContentValidationTests
{
    ...
    public void RecordDiagnosticsFollowManifestThenAuthoredRecordOrder()
    {
        ...
        var races = new SourceContentDocument<RaceDefinition>(
            ...
            new DeserializedContentDocument<RaceDefinition>(1,
            [
        ...
        IReadOnlyList<AilmentDefinition>? ailments = null)
    {
        ...
        return new SkillSystemValidationRequest(
            ...
            "manifest.json",
            registrations,
            [new SourceContentDocument<SkillDefinition>("skills.json", "skills.json", new(1, skills ?? []))],
            [new SourceContentDocument<EntityDefinition>("entities.json", "entities.json", new(1, entities ?? []))],
            [new SourceContentDocument<RaceDefinition>("races.json", "races.json", new(1, races ?? []))],
            [new SourceContentDocument<AilmentDefinition>("ailments.json", "ailments.json", new(1, ailments ?? []))]);
    }
