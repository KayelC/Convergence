...
public sealed class SchemaDeserializationTests
{
    ...
    [Theory]
    [InlineData("{ /* comment */ \"schemaVersion\": 1, \"skills\": [] }", "comment.json")]
    [InlineData("{ \"schemaVersion\": 1, \"skills\": [], }", "trailing-comma.json")]
    [InlineData("{ \"SchemaVersion\": 1, \"skills\": [] }", "case-mismatch.json")]
    [InlineData("{ \"schemaVersion\": 1, \"skills\": \"wrong\" }", "wrong-token.json")]
    [InlineData("{ \"schemaVersion\": 1, \"skills\": null }", "null-collection.json")]
