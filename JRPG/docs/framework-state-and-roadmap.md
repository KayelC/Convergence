...
Phase 2-13 advances the interactive shell from temporary demo combat policies to catalog-bound framework combat math. Its summary now exposes resolved hit, critical, affinity, damage/recovery, effect, and Press Turn evidence, plus a reward preview that is deliberately not applied before Phase 2-19.
