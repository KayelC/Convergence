...
Phase 5-27 extends that clean snapshot with owned active-form, Persona-stock, and Demon-stock references. Training Annex hydrates those stock entries as clean runtime actors, presents them through `Inspect Stock`, and validates saved stock references by actor ownership/team before restoring. It does not add summon, return, swap, dismiss, replace, consume, recruitment, or fusion-driven stock mutation; those remain Phase 5-28 and later capability work.
