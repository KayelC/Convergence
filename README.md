...
schemas/content/v10/                 Draft 2020-12 authoring contracts
...
dotnet run --project tools/Convergence.ContentValidator -- --content-root content --schema-root schemas/content/v10 --registrations config/content-validator/active-samples.registrations.json
